...
\begin{frame}
  \frametitle{斐波那契数列}
  \begin{quote}
  斐波那契数列的发明者是意大利数学家‌列昂纳多·斐波那契\(Leonardo Fibonacci生于公元1170年，卒于1240年（或1250年），籍贯是比萨。斐波那契在1202年撰写的《‌珠算原理》（Liber Abacci）一书中首次引入了这一数列，用以描述兔子繁殖的问题，因此斐波那契数列也被称为“兔子数列”。
  \end{quote}
  \begin{itemize}
    \item 一
    \item 二
